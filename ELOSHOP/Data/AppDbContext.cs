using ELOSHOP.Models;
using Microsoft.AspNetCore.Identity;
using Microsoft.AspNetCore.Identity.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore;

namespace ELOSHOP.Data;
...
NormalizedName = "CLIENTE"
        ...
        {
            Id = Guid.NewGuid().ToString(),
            Email = "admin@eloshop.com",
            NormalizedEmail = "ADMIN@ELOSHOP.COM",
            UserName = "Admin",
        ...
        user.PasswordHash = pass.HashPassword(user, "capivara");
...
RoleId = roles[2].Id
        ...
        List<Produto> produtos = new()
        {
            ...
            new Produto(){
                Id = 2,
                Nome = "Box Trilogia Sombra e Ossos - 1° Ed.",
